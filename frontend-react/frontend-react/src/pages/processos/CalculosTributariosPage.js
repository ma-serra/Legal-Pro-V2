...
import { Calculator, TrendingUp, Scale, BookOpen, AlertTriangle, BarChart3, RefreshCw, FileText, ArrowRight, Percent, Clock, History, Download, Save } from 'lucide-react';
...
function HistoricoSimulacoes() {
    ...
    return (_jsxs("div", { className: "bg-card border border-border rounded-xl p-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h3", { className: "font-bold text-xl", children: "Hist\u00F3rico de Simula\u00E7\u00F5es" }), _jsx("button", { onClick: carregarHistorico, className: "p-2 bg-background border border-border rounded-lg hover:border-primary", children: _jsx(RefreshCw, { className: "w-4 h-4" }) })] }), _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-border text-left", children: [_jsx("th", { className: "py-3 px-4 font-medium text-muted-foreground", children: "Data" }), _jsx("th", { className: "py-3 px-4 font-medium text-muted-foreground", children: "Cliente" }), _jsx("th", { className: "py-3 px-4 font-medium text-muted-foreground", children: "Tipo" }), _jsx("th", { className: "py-3 px-4 font-medium text-muted-foreground", children: "Par\u00E2metros Principais" }), _jsx("th", { className: "py-3 px-4 font-medium text-muted-foreground text-right", children: "A\u00E7\u00F5es" })] }) }), _jsxs("tbody", { children: [simulacoes.map((sim) => (_jsxs("tr", { className: "border-b border-border/50 hover:bg-accent/50", children: [_jsx("td", { className: "py-3 px-4 text-sm", children: new Date(sim.data_criacao).toLocaleString('pt-BR') }), _jsx("td", { className: "py-3 px-4 text-sm font-medium", children: sim.cliente_nome || '-' }), _jsx("td", { className: "py-3 px-4 text-sm", children: _jsx("span", { className: `px-2 py-1 rounded text-xs ${sim.tipo_simulacao === 'COMPARATIVO_REGIME'
                                                    ? 'bg-blue-500/10 text-blue-400'
                                                    : 'bg-green-500/10 text-green-400'}`, children: sim.tipo_simulacao.replace('_', ' ') }) }), _jsxs("td", { className: "py-3 px-4 text-sm text-muted-foreground", children: [Object.entries(sim.parametros_input).slice(0, 2).map(([k, v]) => `${k}: ${v}`).join(', '), "..."] }), _jsx("td", { className: "py-3 px-4 text-sm text-right", children: _jsxs("button", { onClick: () => downloadPDF(sim.id), className: "inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 text-primary rounded-md text-xs font-medium transition-colors", children: [_jsx(Download, { className: "w-3 h-3" }), "PDF"] }) })] }, sim.id))), simulacoes.length === 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 5, className: "py-8 text-center text-muted-foreground", children: "Nenhuma simula\u00E7\u00E3o salva." }) }))] })] }) })] }));
}

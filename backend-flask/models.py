...
class Advogado(db.Model):
    ...
    oab = Column(String(20))
    email = Column(String(255))
    ativo = Column(Boolean, default=True)
    
    def to_dict(self):
        return {'id': self.id, 'nome': self.nome, 'oab': self.oab}

class Fase(db.Model):
    """Modelo para Fases Processuais"""
    __tablename__ = 'fases'
...
class Comarca(db.Model):
    """Modelo para Comarcas"""
    ...
    def to_dict(self):
        return {'id': self.id, 'nome': self.nome, 'uf': self.uf}
...
class Processo(db.Model):
    ...
    comarca_id = Column(Integer, ForeignKey('comarcas.id'))
    ...
    # Relationships
    advogado = relationship('Advogado', backref='processos')
    fase = relationship('Fase', backref='processos')
    comarca = relationship('Comarca', backref='processos')
    ...
    def to_dict(self):
        ...
        return {
            ...
            'advogado': self.advogado.nome if self.advogado else None,
            'fase': self.fase.nome if self.fase else None,
            'comarca': self.comarca.nome if self.comarca else None,
            'data_distribuicao': self.data_distribuicao.isoformat() if self.data_distribuicao else None,
